import { z } from "zod";
import { JOURNEY_STATUSES, PRIORITIES, EMOTIONS, TOUCHPOINTS, } from "../constants.js";
...
export function createJourneyFrontmatter(id, title, overrides = {}) {
...
export function createJourneyContent(title) {
    return `# ${title}
