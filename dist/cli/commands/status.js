...
export const statusCommand = new Command("status")
    ...
    console.log(`  ${pc.dim("Planning:")}     ${epicsByStatus.planning}`);
    console.log(`  ${pc.yellow("In Progress:")}  ${epicsByStatus.in_progress}`);
    console.log(`  ${pc.green("Complete:")}     ${epicsByStatus.complete}`);
    if (epicsByStatus.cancelled > 0) {
        console.log(`  ${pc.red("Cancelled:")}    ${epicsByStatus.cancelled}`);
    }
    console.log();
    // Specs
